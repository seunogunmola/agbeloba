                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        if (count($transactions)) {
                                        ...
                                        <caption>
                                                ...
                                                <h4 class="alert alert-success">
                                                   <?php if(isset($single_student)){
                                                       ?>
                                                    Debit Transactions for <?php echo $transactions[0]->surname.' '. $transactions[0]->othernames; ?>
                                                    <?php
                                                   }
                                                   else if(isset($single_school)) {
                                                    ?>
                                                    Debit Transactions for <?php echo $transactions[0]->school_name ?>
                                                   <?php
                                                    }
                                                   else {?>
                         ...
                         ?>
                        <div align="center"> <a href="<?php echo site_url('Administrator/Reports/Debit_transactions'); ?>"> <button class = "btn btn-primary"> <i class="fa fa-refresh"></i> Refresh Results</button> </a></div>
                        <?php
                        }
                        ?>
                    </div>
