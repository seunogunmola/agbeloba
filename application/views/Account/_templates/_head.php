...
#imagePreview {
    ...
    display: inline-block;
                    ...
                    <li>
                        <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            <img src="images/photos/user-avatar.png" alt="" />
                                <?php echo isset($current_user_fullname) ? $current_user_fullname : ''?>
                            <span class="caret"></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                            <li><a href="<?php echo site_url('Account/Accounts/password')?>"><i class="fa fa-edit"></i> Change Password</a></li>
                            <li><a href="<?php echo site_url('Account/login/logout')?>"><i class="fa fa-sign-out"></i> Log Out</a></li>
                        </ul>
                    </li>
        ...
        <div class="logo" style="background-color:white">
            <a href="<?php echo site_url('Account/dashboard'); ?>"> <img src="<?php echo getResource('images/login_logo.png') ?>" style="max-width:200px" alt=""/> </a>
        </div>
            ...
            <div class="visible-xs hidden-sm hidden-md hidden-lg">
                <div class="media logged-user">
                    ...
                    <div class="media-body">
                        <h4><a href="#"> <?php echo isset($current_user_fullname) ? $current_user_fullname : ''?></a></h4>
                    </div>
                </div>
